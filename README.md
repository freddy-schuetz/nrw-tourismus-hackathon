...
> Für die **öffentliche URL brauchst du ein GitHub-Konto** (Claude legt dort das private Repo an). Reines lokales Vorführen (localhost, Screenshare) geht auch ohne.
